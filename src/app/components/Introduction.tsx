    ...
    const phenomena = [
        {
            ...
            summary: 'Answer in the actual response may sometimes diﬀer from what has been concluded in reasoning',
        ...
        },
        {
            ...
            summary: 'The actual response may still state in a certain, deterministic tone even when obvious uncertainty has been acknowledged in reasoning',
        ...
        },
        {
            ...
            summary: 'Models may pretend to have conducted a web search with fabricated results',
            ...
            examples: [
                {
                    ...
                    note: '(from Gemini 2.5 Pro)',
                },
                {
                    title: 'Hallucinated Web Search',
                    src: `${basePath}/web_search.png`,
                    alt: 'Hallucinated web search',
                    note: '(from Qwen3-235B-A22B-thinking-2507)',
                }
            ]
        },
        {
            ...
            summary: 'Models may pretend to have used external tools',
        ...
        <div className="max-w-5xl mx-auto px-4 py-8 bg-white">
            <div className="space-y-16">
                ...
                <div className="max-w-5xl mx-auto">
                    ...
                    <p className="text-center text-gray-600 mb-8">We evaluate modern LRMs on textual and visual reasoning tasks (four runs for each prompt). The scatter plots display the mean ± standard deviation of overall accuracy versus token usage.</p>
                ...
                <div className="max-w-5xl mx-auto">
                    <h3 className="text-2xl font-bold text-gray-900 mb-2 text-center">Intriguing behaviors of reasoning</h3>
                    <p className="text-center text-gray-600 mb-8">(Click on any example image to view a detailed example of the observed behavior)</p>
                    <div className="overflow-x-auto">
                        <table className="min-w-full border-collapse align-top">
                            <thead>
                                <tr className="bg-white">
                                    <th className="p-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider border-b w-1/2">Behavior</th>
                                    <th className="p-4 text-center text-xs font-medium text-gray-500 uppercase tracking-wider border-b w-1/2">Example</th>
                                </tr>
                            </thead>
